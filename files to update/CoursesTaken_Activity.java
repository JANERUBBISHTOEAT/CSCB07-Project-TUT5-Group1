...
public class CoursesTaken_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("DATABASE").child("STUDENTS").child(studentID).child("course_taken").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        ArrayAdapter<String> itemsAdapter =
                new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, courseTakenList);
